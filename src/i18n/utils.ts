...
const urlMap: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    'cs-karierni-portal-automotive': '/en/case-studies/karierni-portal-automotive',
    'cs-backend-stories': '/en/case-studies/backend-stories',
    'cs-produktove-fotografie-e-commerce': '/en/case-studies/produktove-fotografie-e-commerce',
    'cs-reklamni-bannery-smer-pohledu': '/en/case-studies/reklamni-bannery-smer-pohledu',
    'cs-sablony-e-shopu': '/en/case-studies/sablony-e-shopu',
    'cs-billboardy-sport-marketing': '/en/case-studies/billboardy-sport-marketing',
    about: '/en/about',
  ...
  de: {
    ...
    'cs-karierni-portal-automotive': '/de/fallstudien/karierni-portal-automotive',
    'cs-backend-stories': '/de/fallstudien/backend-stories',
    'cs-produktove-fotografie-e-commerce': '/de/fallstudien/produktove-fotografie-e-commerce',
    'cs-reklamni-bannery-smer-pohledu': '/de/fallstudien/reklamni-bannery-smer-pohledu',
    'cs-sablony-e-shopu': '/de/fallstudien/sablony-e-shopu',
    'cs-billboardy-sport-marketing': '/de/fallstudien/billboardy-sport-marketing',
    about: '/de/ueber-uns',
    partners: '/de/partner',
    blog: '/de/blog',
    contact: '/de/kontakt',
  ...
  fr: {
    ...
    'cs-karierni-portal-automotive': '/fr/etudes-de-cas/karierni-portal-automotive',
    'cs-backend-stories': '/fr/etudes-de-cas/backend-stories',
    'cs-produktove-fotografie-e-commerce': '/fr/etudes-de-cas/produktove-fotografie-e-commerce',
    'cs-reklamni-bannery-smer-pohledu': '/fr/etudes-de-cas/reklamni-bannery-smer-pohledu',
    'cs-sablony-e-shopu': '/fr/etudes-de-cas/sablony-e-shopu',
    'cs-billboardy-sport-marketing': '/fr/etudes-de-cas/billboardy-sport-marketing',
    about: '/fr/a-propos',
  ...
  es: {
    ...
    'cs-karierni-portal-automotive': '/es/casos-de-estudio/karierni-portal-automotive',
    'cs-backend-stories': '/es/casos-de-estudio/backend-stories',
    'cs-produktove-fotografie-e-commerce': '/es/casos-de-estudio/produktove-fotografie-e-commerce',
    'cs-reklamni-bannery-smer-pohledu': '/es/casos-de-estudio/reklamni-bannery-smer-pohledu',
    'cs-sablony-e-shopu': '/es/casos-de-estudio/sablony-e-shopu',
    'cs-billboardy-sport-marketing': '/es/casos-de-estudio/billboardy-sport-marketing',
